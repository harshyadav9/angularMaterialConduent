...
import {MatButtonModule , MatIconModule , MatFormFieldModule ,
     ...
     MatTabsModule,MatSelectModule,MatProgressSpinnerModule,MatDialogModule,MatSnackBarModule,MatRadioModule} from '@angular/material';
...
const MAT_MODULES = [MatButtonModule,MatIconModule,MatFormFieldModule,MatInputModule,
    ...
    MatSelectModule,MatProgressSpinnerModule,MatDialogModule,MatSnackBarModule,MatRadioModule];
@NgModule({
    imports:[MAT_MODULES],
    exports:[MAT_MODULES]
})
